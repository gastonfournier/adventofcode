...
public class Day15 implements Solution<Integer, Long> {
    ...
    public Long part2(List<String> input) {
        ...
        List<Tuple2<Point, Integer>> sensorsAndDistances = sensors.stream()
        ...
        for (int x = 0; x < part2limit; x++) {
            ...
            while (y <= part2limit) {
                ...
                Optional<Tuple2<Point, Integer>> closerSensorWithDistance = sensorsAndDistances.stream()
                ...
                if (yDistanceToSensor > 0) {
                    ...
                    y += closerSensorWithDistance.get()._2 - current.manhattanDistance(closerSensorWithDistance.get()._1) + 1;
                } else {
                    y ++;
                }
            }
    ...
    private Tuple2<SparseMatrix<Character>, List<Tuple2<Point, Point>>> processInput(List<String> input) {
        ...
        // instead of making a matrix that grows, I'm predicting what the max matrix can be and allocating accordingly
